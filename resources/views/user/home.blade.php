      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +88019911702</a>
              <span class="divider">|</span>
              <a href="#"><span class="mai-mail text-primary"></span> eftyfarhan@gmail.com</a>
            </div>
          </div>
    ...
    <div class="container">
      <div class="row px-md-3">
        ...
        <div class="col-sm-6 col-lg-3 py-3">
          ...
          <a href="#" class="footer-link">0000000000</a>
